...
var fit = (function() {
    ...
    */
    ...
    function fit( target, container, options, callback, transform ) {
        ...
        var wa = rect.width || target.width;
        var ha = rect.height || target.height;
        
        var wb = area.width || container.width;
        var hb = area.height || container.height;
        ...
        transform.height = ha * scale;
        transform.width = wa * scale;
